...
const CardForm: FC<PropTypes> = ({ setIsPaying, bookingInput }) => {
	...
	return (
		<div className="flex flex-col gap-12">
			<PaymentElement onChange={handlePaymentElementChange} onReady={handleCardFormLoad} />
			{errorMessage && (
				<p className="text-red-500 rounded border border-red-500 bg-red-50 px-4 py-3">
					{errorMessage}
				</p>
			)}
			{hasCardFormLoaded && (
				<PaymentButton
					text="Pay Now"
					disabled={!stripe || !elements || !isCardFormComplete}
