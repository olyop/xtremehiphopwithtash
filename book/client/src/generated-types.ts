...
export type CancelBookingMutation = (
  { readonly cancelBookingByID: string }
  & { readonly __typename: 'Mutation' }
);
...
export type CheckInBookingMutation = (
  { readonly checkInBooking: string }
  & { readonly __typename: 'Mutation' }
);
...
export type GetBookingReceiptUrlQuery = (
  { readonly getBookingReceiptURL: string }
  & { readonly __typename: 'Query' }
);
...
export type GetCourseFormDataQuery = (
  { readonly getInstructors: ReadonlyArray<(
    { readonly instructorID: string, readonly photo: string, readonly details: (
      { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null }
      & { readonly __typename: 'Details' }
    ) }
    & { readonly __typename: 'Instructor' }
  )> | null, readonly getLocations: ReadonlyArray<(
    { readonly locationID: string, readonly name: string }
    & { readonly __typename: 'Location' }
  )> | null }
  & { readonly __typename: 'Query' }
);
...
export type GetSessionFormDataQuery = (
  { readonly getCourses: ReadonlyArray<(
    { readonly courseID: string, readonly name: string, readonly photo: string, readonly defaultPrice: number | null, readonly defaultEquipmentFee: number | null, readonly defaultDuration: number, readonly defaultCapacityAvailable: number, readonly defaultEquipmentAvailable: number | null, readonly defaultLocation: (
      { readonly locationID: string, readonly name: string, readonly plusCode: string, readonly coordinates: (
        { readonly latitude: number, readonly longitude: number }
        & { readonly __typename: 'Coordinates' }
      ) }
      & { readonly __typename: 'Location' }
    ), readonly defaultInstructors: ReadonlyArray<(
      { readonly instructorID: string, readonly details: (
        { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null }
        & { readonly __typename: 'Details' }
      ) }
      & { readonly __typename: 'Instructor' }
    ...
    { readonly locationID: string, readonly name: string }
    & { readonly __typename: 'Location' }
  )> | null, readonly getInstructors: ReadonlyArray<(
    { readonly instructorID: string, readonly photo: string, readonly details: (
      { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null }
      & { readonly __typename: 'Details' }
    ) }
...
export type GetAccountPageQuery = (
  { readonly getStudentByID: (
    { readonly studentID: string, readonly createdAt: number, readonly details: (
      { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly emailAddress: string, readonly mobilePhoneNumber: string, readonly instagramUsername: string | null }
      & { readonly __typename: 'Details' }
    ), readonly bookings: ReadonlyArray<(
      { readonly bookingID: string, readonly notes: string | null, readonly createdAt: number, readonly bookingQuantity: number, readonly equipmentQuantity: number | null, readonly paymentMethod: PaymentMethod | null, readonly cost: number | null, readonly isCheckedIn: boolean, readonly isCancelled: boolean, readonly session: (
        { readonly sessionID: string, readonly title: string, readonly startTime: number, readonly endTime: number }
        & { readonly __typename: 'Session' }
      ) }
      & { readonly __typename: 'Booking' }
    )> | null }
...
export type GetClassDescriptionQuery = (
...
export type UpdateClassDescriptionMutation = (
  { readonly updateClassDescription: string }
  & { readonly __typename: 'Mutation' }
);
...
export type GenerateCouponMutation = (
  { readonly generateCoupon: string }
  & { readonly __typename: 'Mutation' }
);
...
export type CreateCourseMutation = (
  { readonly createCourse: (
    { readonly courseID: string, readonly name: string, readonly description: string, readonly photo: string, readonly defaultPrice: number | null, readonly defaultEquipmentFee: number | null, readonly defaultDuration: number, readonly defaultCapacityAvailable: number, readonly defaultEquipmentAvailable: number | null, readonly defaultLocation: (
      { readonly locationID: string, readonly name: string }
      & { readonly __typename: 'Location' }
    ), readonly defaultInstructors: ReadonlyArray<(
      { readonly instructorID: string, readonly photo: string, readonly details: (
        { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly mobilePhoneNumber: string, readonly emailAddress: string }
        & { readonly __typename: 'Details' }
      ) }
      & { readonly __typename: 'Instructor' }
    )> }
...
export type DeleteCourseMutation = (
  { readonly deleteCourseByID: string }
  & { readonly __typename: 'Mutation' }
);
...
export type GetCoursesQuery = (
  { readonly getCourses: ReadonlyArray<(
    { readonly courseID: string, readonly name: string, readonly description: string, readonly photo: string, readonly defaultPrice: number | null, readonly defaultEquipmentFee: number | null, readonly defaultDuration: number, readonly defaultCapacityAvailable: number, readonly defaultEquipmentAvailable: number | null, readonly defaultLocation: (
      ...
      { readonly instructorID: string, readonly photo: string, readonly details: (
        { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly emailAddress: string, readonly mobilePhoneNumber: string }
        & { readonly __typename: 'Details' }
      ) }
      & { readonly __typename: 'Instructor' }
    )> }
...
export type CreateInstructorMutation = (
  { readonly createInstructor: (
    { readonly instructorID: string, readonly photo: string, readonly createdAt: number, readonly details: (
      { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly mobilePhoneNumber: string, readonly emailAddress: string, readonly instagramUsername: string | null, readonly createdAt: number }
      & { readonly __typename: 'Details' }
    ) }
    & { readonly __typename: 'Instructor' }
  ) }
...
export type DeleteInstructorMutation = (
  { readonly deleteInstructorByID: string }
  & { readonly __typename: 'Mutation' }
);
...
export type GetInstructorsQuery = (
  { readonly getInstructors: ReadonlyArray<(
    { readonly instructorID: string, readonly photo: string, readonly details: (
      { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly emailAddress: string, readonly mobilePhoneNumber: string, readonly instagramUsername: string | null, readonly createdAt: number }
      & { readonly __typename: 'Details' }
    ) }
    & { readonly __typename: 'Instructor' }
  )> | null }
...
export type DeleteLocationMutation = (
  { readonly deleteLocationByID: string }
  & { readonly __typename: 'Mutation' }
);
...
export type GetLocationsQuery = (
  { readonly getLocations: ReadonlyArray<(
    { readonly locationID: string, readonly name: string, readonly plusCode: string, readonly address: string, readonly coordinates: (
      { readonly latitude: number, readonly longitude: number }
      & { readonly __typename: 'Coordinates' }
    ) }
    & { readonly __typename: 'Location' }
...
export type SearchPlaceByNameQuery = (
  { readonly searchPlaceByName: (
    { readonly address: string, readonly plusCode: string, readonly coordinates: (
      { readonly latitude: number, readonly longitude: number }
      & { readonly __typename: 'Coordinates' }
    ) }
    & { readonly __typename: 'Place' }
...
export type GetStudentsQuery = (
  { readonly getGrossTotal: number | null, readonly getStudentsTotal: number | null, readonly getBookingsTotal: number | null, readonly getStudents: ReadonlyArray<(
    { readonly studentID: string, readonly bookingsTotal: number | null, readonly bookingsTotalPaymentMethodFree: number | null, readonly bookingsTotalPaymentMethodCard: number | null, readonly bookingsTotalPaymentMethodCash: number | null, readonly details: (
      { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly emailAddress: string, readonly mobilePhoneNumber: string, readonly instagramUsername: string | null }
      & { readonly __typename: 'Details' }
    ) }
    & { readonly __typename: 'Student' }
...
export type GetMerchItemsQuery = (
  { readonly getMerchItems: ReadonlyArray<(
    { readonly merchItemID: string, readonly name: string, readonly description: string | null, readonly price: number, readonly photo: string, readonly stock: number | null, readonly sizesAvailable: ReadonlyArray<string> | null }
    & { readonly __typename: 'MerchItem' }
  )> }
  & { readonly __typename: 'Query' }
);
...
export type GetPaymentSuccessDataQuery = (
  { readonly getSessionByID: (
    { readonly sessionID: string, readonly title: string, readonly price: number | null, readonly equipmentFee: number | null, readonly startTime: number, readonly endTime: number, readonly capacityRemaining: number | null, readonly isCancelled: boolean, readonly location: (
      { readonly locationID: string, readonly name: string }
      & { readonly __typename: 'Location' }
    ), readonly course: (
      { readonly courseID: string, readonly name: string, readonly photo: string }
      & { readonly __typename: 'Course' }
    ) }
    & { readonly __typename: 'Session' }
  ) }
...
export type CreateBookingMutation = (
  { readonly createBooking: (
    { readonly bookingID: string, readonly session: (
...
export type GetPaymentScreenDataQuery = (
  { readonly getSessionByID: (
    { readonly sessionID: string, readonly title: string, readonly price: number | null, readonly equipmentFee: number | null, readonly startTime: number, readonly endTime: number, readonly capacityRemaining: number | null, readonly equipmentRemaining: number | null, readonly isCancelled: boolean, readonly location: (
      { readonly locationID: string, readonly name: string }
      & { readonly __typename: 'Location' }
    ), readonly course: (
      { readonly courseID: string, readonly name: string, readonly photo: string }
    ...
    { readonly sessionCost: number, readonly equipmentCost: number, readonly bookingCost: number, readonly couponDiscountPercentage: number, readonly couponAmountToDiscount: number, readonly couponDiscount: number, readonly cost: number, readonly isFreeFromCoupon: boolean, readonly cardFee: number, readonly cardSurchargeRatio: number, readonly cardSurcharge: number, readonly cardSurchargeWithoutFee: number, readonly finalCost: number }
    & { readonly __typename: 'BookingCost' }
  ) }
  & { readonly __typename: 'Query' }
);

export type GetCheckSessionQueryVariables = Exact<{
  sessionID: Scalars['UUID']['input'];
  bookingQuantity: Scalars['PositiveInt']['input'];
  equipmentQuantity: InputMaybe<Scalars['PositiveInt']['input']>;
}>;
...
export type GetCheckSessionQuery = (
  { readonly getSessionByID: (
    { readonly sessionID: string, readonly isCancelled: boolean, readonly isCapacityRemaining: boolean, readonly isEquipmentRemaining: boolean }
    & { readonly __typename: 'Session' }
  ) }
  & { readonly __typename: 'Query' }
);
...
export type VerifyCouponQuery = (
  { readonly verifyCoupon: string | null }
  & { readonly __typename: 'Query' }
);
...
export type GetSessionsInPeriodQuery = (
  { readonly getSessionsInPeriod: ReadonlyArray<(
    { readonly sessionID: string, readonly title: string, readonly startTime: number, readonly endTime: number, readonly price: number | null, readonly hasBooked: boolean, readonly viewsCount: number | null, readonly capacityRemaining: number | null, readonly capacityBooked: number | null, readonly isCancelled: boolean, readonly location: (
      { readonly locationID: string, readonly name: string }
      & { readonly __typename: 'Location' }
    ), readonly course: (
      { readonly courseID: string, readonly name: string, readonly photo: string }
...
export type GetSessionBookingsQuery = (
  { readonly getSessionByID: (
    { readonly sessionID: string, readonly gross: number | null, readonly bookings: ReadonlyArray<(
      { readonly bookingID: string, readonly notes: string | null, readonly createdAt: number, readonly bookingQuantity: number, readonly equipmentQuantity: number | null, readonly paymentMethod: PaymentMethod | null, readonly paymentIntentID: string | null, readonly cost: number | null, readonly isCheckedIn: boolean, readonly isCancelled: boolean, readonly cancelledAt: number | null, readonly session: (
        { readonly sessionID: string }
        & { readonly __typename: 'Session' }
      ), readonly student: (
        { readonly studentID: string, readonly details: (
          { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly emailAddress: string, readonly mobilePhoneNumber: string, readonly instagramUsername: string | null }
          & { readonly __typename: 'Details' }
        ) }
        & { readonly __typename: 'Student' }
...
export type CancelSessionMutation = (
  { readonly cancelSessionByID: string }
  & { readonly __typename: 'Mutation' }
);
...
export type DeleteSessionMutation = (
  { readonly deleteSessionByID: string }
  & { readonly __typename: 'Mutation' }
);
...
export type GetSessionPageQuery = (
  { readonly getClassDescription: string, readonly getSessionByID: (
    { readonly sessionID: string, readonly title: string, readonly notes: string | null, readonly startTime: number, readonly endTime: number, readonly price: number | null, readonly hasBooked: boolean, readonly equipmentFee: number | null, readonly capacityAvailable: number, readonly capacityBooked: number | null, readonly capacityRemaining: number | null, readonly equipmentAvailable: number | null, readonly equipmentHired: number | null, readonly equipmentRemaining: number | null, readonly isCapacityRemaining: boolean, readonly isCancelled: boolean, readonly viewsCount: number | null, readonly createdAt: number, readonly location: (
      { readonly locationID: string, readonly name: string, readonly plusCode: string, readonly address: string, readonly coordinates: (
        { readonly latitude: number, readonly longitude: number }
        & { readonly __typename: 'Coordinates' }
      ) }
      ...
      { readonly courseID: string, readonly name: string, readonly photo: string, readonly description: string }
      & { readonly __typename: 'Course' }
...
export type ViewSessionMutation = (
  { readonly viewSession: boolean }
  & { readonly __typename: 'Mutation' }
);
...
export type SessionViewsQuery = (
  { readonly getSessionByID: (
    { readonly sessionID: string, readonly views: ReadonlyArray<(
      { readonly hasBooked: boolean, readonly hasCancelled: boolean, readonly createdAt: number, readonly student: (
        { readonly studentID: string, readonly details: (
          { readonly detailsID: string, readonly firstName: string, readonly lastName: string, readonly nickName: string | null, readonly emailAddress: string, readonly mobilePhoneNumber: string, readonly instagramUsername: string | null, readonly createdAt: number }
          & { readonly __typename: 'Details' }
        ) }
...
export type CheckStudentQuery = (
  { readonly doesStudentExist: boolean, readonly isStudentAdministator: boolean }
  & { readonly __typename: 'Query' }
);
