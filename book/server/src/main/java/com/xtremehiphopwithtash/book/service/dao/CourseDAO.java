...
import com.xtremehiphopwithtash.book.service.dao.query.CourseQuery;
import com.xtremehiphopwithtash.book.service.dao.rowmapper.CourseRowMapper;
...
public class CourseDAO implements EntityBaseDAO<Course, UUID>, EntityUpdateDAO<Course, UUID>, EntityDeleteDAO<UUID> {
	...
	public Course insert(Course course) {
		...
		paramSource.addValue("defaultCapacityAvailable", course.getDefaultCapacityAvailable());
	...
	@Override
	public Course selectByID(UUID courseID) {
